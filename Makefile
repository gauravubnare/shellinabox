...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(srcdir)/config.h.in depcomp $(dist_doc_DATA) \
	$(noinst_HEADERS) COPYING TODO compile config.guess config.sub \
...
am__objects_1 =
am_libhttp_la_OBJECTS = libhttp/hashmap.lo libhttp/trie.lo \
	libhttp/httpconnection.lo libhttp/server.lo libhttp/ssl.lo \
	libhttp/url.lo $(am__objects_1)
libhttp_la_OBJECTS = $(am_libhttp_la_OBJECTS)
AM_V_lt = $(am__v_lt_$(V))
am__v_lt_ = $(am__v_lt_$(AM_DEFAULT_VERBOSITY))
am__v_lt_0 = --silent
am__v_lt_1 = 
libhttp_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(AM_CFLAGS) $(CFLAGS) \
	$(libhttp_la_LDFLAGS) $(LDFLAGS) -o $@
liblogging_la_LIBADD =
am_liblogging_la_OBJECTS = logging/logging.lo $(am__objects_1)
liblogging_la_OBJECTS = $(am_liblogging_la_OBJECTS)
liblogging_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(AM_CFLAGS) $(CFLAGS) \
	$(liblogging_la_LDFLAGS) $(LDFLAGS) -o $@
am__installdirs = "$(DESTDIR)$(bindir)" "$(DESTDIR)$(man1dir)" \
	"$(DESTDIR)$(docdir)"
PROGRAMS = $(bin_PROGRAMS)
am_shellinaboxd_OBJECTS = shellinabox/shellinaboxd.$(OBJEXT) \
	shellinabox/externalfile.$(OBJEXT) \
	shellinabox/launcher.$(OBJEXT) \
	shellinabox/privileges.$(OBJEXT) shellinabox/service.$(OBJEXT) \
	shellinabox/session.$(OBJEXT) shellinabox/usercss.$(OBJEXT)
shellinaboxd_OBJECTS = $(am_shellinaboxd_OBJECTS)
shellinaboxd_DEPENDENCIES = liblogging.la libhttp.la
shellinaboxd_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(AM_CFLAGS) $(CFLAGS) \
...
ACLOCAL = ${SHELL} /shellinabox/missing aclocal-1.13
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AR_FLAGS = cr
AUTOCONF = ${SHELL} /shellinabox/missing autoconf
AUTOHEADER = ${SHELL} /shellinabox/missing autoheader
AUTOMAKE = ${SHELL} /shellinabox/missing automake-1.13
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /shellinabox/missing makeinfo
MANIFEST_TOOL = :
...
PACKAGE_STRING = shellinabox 2.20
...
SHELL = /bin/sh
STRIP = strip
VCS_REVISION =  (revision 4f0ecc3)
VERSION = 2.20
abs_builddir = /shellinabox
abs_srcdir = /shellinabox
abs_top_builddir = /shellinabox
abs_top_srcdir = /shellinabox
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /shellinabox/install-sh
...
libhttp/$(am__dirstamp):
	@$(MKDIR_P) libhttp
	@: > libhttp/$(am__dirstamp)
libhttp/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) libhttp/$(DEPDIR)
	@: > libhttp/$(DEPDIR)/$(am__dirstamp)
libhttp/hashmap.lo: libhttp/$(am__dirstamp) \
	libhttp/$(DEPDIR)/$(am__dirstamp)
libhttp/trie.lo: libhttp/$(am__dirstamp) \
	libhttp/$(DEPDIR)/$(am__dirstamp)
libhttp/httpconnection.lo: libhttp/$(am__dirstamp) \
	libhttp/$(DEPDIR)/$(am__dirstamp)
libhttp/server.lo: libhttp/$(am__dirstamp) \
	libhttp/$(DEPDIR)/$(am__dirstamp)
libhttp/ssl.lo: libhttp/$(am__dirstamp) \
	libhttp/$(DEPDIR)/$(am__dirstamp)
libhttp/url.lo: libhttp/$(am__dirstamp) \
	libhttp/$(DEPDIR)/$(am__dirstamp)

libhttp.la: $(libhttp_la_OBJECTS) $(libhttp_la_DEPENDENCIES) $(EXTRA_libhttp_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(libhttp_la_LINK)  $(libhttp_la_OBJECTS) $(libhttp_la_LIBADD) $(LIBS)
...
logging/$(DEPDIR)/$(am__dirstamp):
	...
	@: > logging/$(DEPDIR)/$(am__dirstamp)
logging/logging.lo: logging/$(am__dirstamp) \
	logging/$(DEPDIR)/$(am__dirstamp)

liblogging.la: $(liblogging_la_OBJECTS) $(liblogging_la_DEPENDENCIES) $(EXTRA_liblogging_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(liblogging_la_LINK)  $(liblogging_la_OBJECTS) $(liblogging_la_LIBADD) $(LIBS)
...
shellinabox/$(DEPDIR)/$(am__dirstamp):
	...
	@: > shellinabox/$(DEPDIR)/$(am__dirstamp)
shellinabox/shellinaboxd.$(OBJEXT): shellinabox/$(am__dirstamp) \
	shellinabox/$(DEPDIR)/$(am__dirstamp)
shellinabox/externalfile.$(OBJEXT): shellinabox/$(am__dirstamp) \
	shellinabox/$(DEPDIR)/$(am__dirstamp)
shellinabox/launcher.$(OBJEXT): shellinabox/$(am__dirstamp) \
	shellinabox/$(DEPDIR)/$(am__dirstamp)
shellinabox/privileges.$(OBJEXT): shellinabox/$(am__dirstamp) \
	shellinabox/$(DEPDIR)/$(am__dirstamp)
shellinabox/service.$(OBJEXT): shellinabox/$(am__dirstamp) \
	shellinabox/$(DEPDIR)/$(am__dirstamp)
shellinabox/session.$(OBJEXT): shellinabox/$(am__dirstamp) \
	shellinabox/$(DEPDIR)/$(am__dirstamp)
shellinabox/usercss.$(OBJEXT): shellinabox/$(am__dirstamp) \
	shellinabox/$(DEPDIR)/$(am__dirstamp)

shellinaboxd$(EXEEXT): $(shellinaboxd_OBJECTS) $(shellinaboxd_DEPENDENCIES) $(EXTRA_shellinaboxd_DEPENDENCIES) 
	@rm -f shellinaboxd$(EXEEXT)
	$(AM_V_CCLD)$(shellinaboxd_LINK) $(shellinaboxd_OBJECTS) $(shellinaboxd_LDADD) $(LIBS)
...
mostlyclean-compile:
	...
	-rm -f logging/*.$(OBJEXT)
	-rm -f logging/*.lo
	-rm -f shellinabox/*.$(OBJEXT)

distclean-compile:
	-rm -f *.tab.c

include libhttp/$(DEPDIR)/hashmap.Plo
include libhttp/$(DEPDIR)/httpconnection.Plo
include libhttp/$(DEPDIR)/server.Plo
include libhttp/$(DEPDIR)/ssl.Plo
include libhttp/$(DEPDIR)/trie.Plo
include libhttp/$(DEPDIR)/url.Plo
include logging/$(DEPDIR)/logging.Plo
include shellinabox/$(DEPDIR)/externalfile.Po
include shellinabox/$(DEPDIR)/launcher.Po
include shellinabox/$(DEPDIR)/privileges.Po
include shellinabox/$(DEPDIR)/service.Po
include shellinabox/$(DEPDIR)/session.Po
include shellinabox/$(DEPDIR)/shellinaboxd.Po
include shellinabox/$(DEPDIR)/usercss.Po
...
clean-libtool:
	-rm -rf .libs _libs
	-rm -rf libhttp/.libs libhttp/_libs
...
distclean-generic:
	...
	-rm -f libhttp/$(DEPDIR)/$(am__dirstamp)
	-rm -f libhttp/$(am__dirstamp)
...
distclean: distclean-am
	...
	-rm -rf libhttp/$(DEPDIR) logging/$(DEPDIR) shellinabox/$(DEPDIR)
	-rm -f Makefile
...
.jspp.js:
	...
	sed -e "`sed -e 's/^#define *\([^ ]*\) *\(.*\)/\/^[^#]\/s\/\1\/\2 \\\\\/* \1 *\\\\\/\/g/' \
	             ...
	             -e d "$<"`"                                              \
	     -e "s/^#/\/\/ #/"                                                \
	     -e "s/VERSION/\"2.20  (revision 4f0ecc3)\"/g"                    \
	     "$<" >"$@"
